...
old_core = '''      <h3>Detection-Informed Security Engineering</h3>
...
new_core = '''      <h3>Detection-Informed Security Engineering &amp; Telemetry</h3>
...
index = replace_once(index, old_core, new_core, "core defensive expertise card")
...
old_tatva = '''                      <ul class="experience-points">
                        ...
                        <li>Worked with firewall rules, VPN, NAT, SNMP, syslog, segmentation, network troubleshooting, and availability controls across customer environments.</li>
                        <li>Translated technical issues into controlled implementation steps, remediation actions, operational documentation, and stakeholder-ready status updates.</li>
                      </ul>'''
new_tatva = '''                      <ul class="experience-points">
...
index = replace_once(index, old_tatva, new_tatva, "Tatva experience bullets")

old_case_1 = '''      <p class="eyebrow">Compliance validation lab</p>
      <h3>Wazuh 5 Beta SOC Lab for ISO 27001</h3>
...
new_case_1 = '''      <p class="eyebrow">SIEM / XDR validation lab</p>
      <h3>Wazuh 5 Beta SOC Lab for ISO 27001</h3>
...
index = replace_once(index, old_case_1, new_case_1, "Wazuh validation case")

old_case_2 = '''      <p class="eyebrow">Unified visibility</p>
      <h3>Wazuh + Grafana + Zabbix dashboard</h3>
...
new_case_2 = '''      <p class="eyebrow">SIEM analytics &amp; unified visibility</p>
      <h3>Wazuh + Grafana + Zabbix dashboard</h3>
...
index = replace_once(index, old_case_2, new_case_2, "unified visibility case")

old_case_3 = '''      <p class="eyebrow">Log engineering</p>
      <h3>Firewall syslog ingestion into Wazuh 5</h3>
...
new_case_3 = '''      <p class="eyebrow">SIEM ingestion &amp; log engineering</p>
      <h3>Firewall syslog ingestion into Wazuh 5</h3>
...
index = replace_once(index, old_case_3, new_case_3, "firewall SIEM case")

old_case_4 = '''      <p class="eyebrow">Incident workflow automation</p>
...
new_case_4 = '''      <p class="eyebrow">SOAR-aligned workflow automation</p>
...
index = replace_once(index, old_case_4, new_case_4, "GLPI automation case")

old_capability = '''    <article class="capability-group card" data-reveal>
...
new_capability = '''    <article class="capability-group card" data-reveal>
...
index = replace_once(index, old_capability, new_capability, "defensive capability matrix")
